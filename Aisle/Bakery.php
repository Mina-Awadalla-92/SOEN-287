      ...
      <div class="main-content col-md-10">
          <div class="row">
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                  <div class="card">
                      <a href="Product Description/french baguettes.php"><img class="item-pic"
                      ...
                      <div class="card-body">
                          ...
                          <p class="card-text ">1 French Baguette <br> <br> <br><span>$</span><span class="cost">1.00</span>
                              <span class="unit">/ Baguette</span> <br> <span class="gram">$1.00 / Baguette</span></p>
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                  <div class="card">
                      <a href="Product Description/rye bread.php"><img class="item-pic"
                      ...
                      <div class="card-body">
                          ...
                          <p class="card-text ">1 Loaf of Rye Bread<br> <br> <br><span>$</span><span class="cost">4.55</span>
                             <span class="unit">/ Loaf of Rye Bread</span>  <br> <span class="gram">$4.55 / Loaf</span></p>
                          <button class="btn btn-dark">ADD TO CART</button>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                  <div class="card">
                      <a href="../Aisle\Product Description\sourdough bread.html"><img class="item-pic"
                      ...
                      <div class="card-body">
                          ...
                          <p class="card-text ">1 Loaf of Sourdough Bread<br> <br> <br> <span>$</span><span class="cost">6.96</span><span>/ Loaf of Sourdough Bread</span> 
                            <br> <span class="gram">$6.96</span> <span class = "unit">Loaf of Sourdough Bread </span></p>
                          <button class="btn btn-dark">ADD TO CART</button>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                  <div class="card">
                      <a href="Product Description/challah bread.php"><img class="item-pic"
                                                                           ...
                                                                           class="card-img-top apples" alt="..."></a>
                      <div class="card-body">
                          ...
                          <p class="card-text ">1 Loaf of Challah Bread <br> <br> <br><span>$</span><span class="cost">3.50</span>
                             <span class = "unit">/ Loaf of Challah Bread</span>  <br> <span class="gram">$3.50 / Loaf</span></p>
                          <button class="btn btn-dark">ADD TO CART</button>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                <div class="card">
                    <a href="../Aisle\Product Description\bagels.html"><img class="item-pic"
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text ">1 Bagel<br> <br> <br><span>$</span><span class="cost">1.55</span>
                           <span class = "unit">/ Bagel</span>  <br> <span class="gram">$1.55 / Bagel</span></p>
                        <button class="btn btn-dark">ADD TO CART</button>
                    </div>
                </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
              <div class="card">
                  <a href="../Aisle\Product Description\whole wheat bread.html"><img class="item-pic"
                  ...
                  <div class="card-body">
                      ...
                      <p class="card-text ">1 Loaf of Whole Wheat Bread<br> <br> <br><span>$</span><span class="cost">3.25</span>
                         <span class = "unit">/ Loaf of Whole Wheat Bread</span>  <br> <span class="gram">$3.25 / Loaf</span></p>
                      <button class="btn btn-dark">ADD TO CART</button>
                  </div>
              </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
            <div class="card">
                <a href="../Aisle\Product Description\brioche bread.html"><img class="item-pic"
                                                                          src="https://images.unsplash.com/photo-1620921568790-c1cf8984624c?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80"
                                                                          class="card-img-top" alt="..."></a>
                <div class="card-body" id="bb">
                    ...
                    <p class="card-text ">1 Loaf of Brioche Bread<br> <br> <br><span>$</span><span class="cost">3.75</span>
                      <span class = "unit">/ Loaf of Brioche Bread</span>   <br> <span class="gram">$3.75 / Loaf</span></p>
                    <button class="btn btn-dark">ADD TO CART</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
          <div class="card">
              <a href="../Aisle\Product Description\pita bread.html"><img class="item-pic"
                                                                        src="https://images.unsplash.com/photo-1583057341912-a0df64b8da4d?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1074&q=80"
                                                                        class="card-img-top" alt="..."></a>
              <div class="card-body">
                  ...
                  <p class="card-text ">1 Slice of Pita Bread<br> <br> <br><span>$</span><span class="cost">0.89</span>
                      <span class="unit">/ Slice of Pita Bread</span> <br> <span class="gram">$0.89 / Unit</span></p>
                  <button class="btn btn-dark" >ADD TO CART</button>
              </div>
          </div>
      </div>
