        ...
        <div class="main-content col-md-10">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                    <div class="card">
                        <a href="Product Description/Crab.php"><img class="item-pic"
                                                                    src="https://www.marchespublics-mtl.com/wp-content/uploads/MPM_Poissons_Crabe.jpg"
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                    <div class="card">
                        <a href="Product Description/Lobster.php"><img class="item-pic"
                                                                       src="https://www.washingtonpost.com/rf/image_982w/2010-2019/WashingtonPost/2020/08/13/Food/Images/v-howto-lobster_029.JPG"
                                                                       class="card-img-top" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                    <div class="card">
                        <a href="Product Description/Shrimp.php"><img class="item-pic"
                                                                      src="https://www.sweetandsavorybyshinee.com/wp-content/uploads/2021/05/Shrimp-2-1.jpg"
                                                                      class="card-img-top" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                    <div class="card">
                        <a href="Product Description/Oysters.php"><img class="item-pic"
                                                                       src="https://thumbor.forbes.com/thumbor/960x0/https%3A%2F%2Fblogs-images.forbes.com%2Fcourtneyschiessl%2Ffiles%2F2018%2F05%2FOysters_int.jpg"
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                    <div class="card">
                        <a href="Product Description/WildSalmon.php"><img class="item-pic"
                                                                          src="https://www.skinnytaste.com/wp-content/uploads/2018/12/Baked-Salmon-1.jpg"
                                                                          class="card-img-top apples" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                    <div class="card">
                        <a href="Product Description/TunaSteak.php"><img class="item-pic"
                                                                         src="https://theheritagecook.com/wp-content/uploads/2012/01/Raw-Ahi-Tuna-Steaks2-iStock.jpg"
                                                                         class="card-img-top apples" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                    <div class="card">
                        <a href="Product Description/Calamari.php"><img class="item-pic"
                                                                        src="https://www.thespruceeats.com/thmb/3IAKAM_nPxKNRJfrdNsVdktNeH4=/960x0/filters:no_upscale():max_bytes(150000):strip_icc()/calamari_1806999-2-e8a531d5915e49719d5b049fd6fa00a1.jpg"
                                                                        class="card-img-top apples" alt="..."></a>
                        <div class="card-body">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                    <div class="card">
                        <a href="Product Description/Caviar.php"><img class="item-pic"
                                                                      src="https://upload.wikimedia.org/wikipedia/commons/f/ff/Caviar_spoons.jpg"
                                                                      class="card-img-top apples" alt="..."></a>
                        <div class="card-body">
