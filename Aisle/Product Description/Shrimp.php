...
<div class="div1">
    <a class = "none" href="../Seafood.php" > <h1 class="h1" >SEAFOOD</h1> </a>
</div>
        ...
        <div class="container" style="margin-top:30px">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                    ...
                    <br>
                    <button type="button" class="btn btn-dark btn1"1
                        <i class="fas fa-shopping-cart fas"></i> Add1to Shopping Cart
                    </button>
