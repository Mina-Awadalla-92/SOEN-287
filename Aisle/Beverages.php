      ...
      <div class="main-content col-md-10">
          <div class="row">
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                  <div class="card">
                      <a href="Product Description/water.php"><img class="item-pic"
                                                                   src="https://www.factsaboutbpa.org/wp-content/uploads/2017/09/waterbottles.png"
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                  <div class="card">
                      <a href="Product Description/coca.php"><img class="item-pic"
                                                                  src="https://images.unsplash.com/photo-1624797375978-8c2f746bdd3a?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fGNvbGF8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60"
                                                                  class="card-img-top" alt="..."></a>
                      <div class="card-body">
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                  <div class="card">
                      <a href="Product Description/7up.php"><img class="item-pic"
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                  <div class="card">
                      <a href="Product Description/monster.php"><img class="item-pic"
                                                                     src="https://images.unsplash.com/photo-1551870573-6f5e93e660fd?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80"
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
                <div class="card">
                    <a href="Product Description/redbull.php"><img class="item-pic"
                                                                   src="https://cdn.pixabay.com/photo/2018/04/08/14/46/red-bull-3301415_1280.jpg"
                                                                   class="card-img-top apples" alt="..."></a>
                    <div class="card-body">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
              <div class="card">
                  <a href="Product Description/fanta.php"><img class="item-pic"
                                                               src="https://st.depositphotos.com/2121815/4264/i/600/depositphotos_42646321-stock-photo-can-of-fanta-drink-on.jpg"
                                                               class="card-img-top apples" alt="..."></a>
                  <div class="card-body">
          ...
          <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
            <div class="card">
                <a href="Product Description/orangejuice.php"><img class="item-pic"
                                                                   src="https://www.packagingstrategies.com/ext/resources/Issues/June/July2012/Laura_uploads/Tropicana540.jpg?1559144132"
                                                                   class="card-img-top apples" alt="..."></a>
                <div class="card-body">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-2">
          <div class="card">
              <a href="Product Description/canadadry.php"><img class="item-pic"
                                                               src="https://preview.free3d.com/img/2020/01/2279683203843229623/civw902w-900.jpg"
                                                               class="card-img-top apples" alt="..."></a>
              <div class="card-body">
